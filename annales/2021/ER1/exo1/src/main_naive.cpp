...
void producer(NaiveBlockingQueue<std::string> &queue, int to_produce)
{
...
void consumer(NaiveBlockingQueue<std::string> &queue, int to_consume)
{
...
int main()
{
	NaiveBlockingQueue<std::string> queue(100);
